...
var serviceWorker = function serviceWorker() {
  var websocketURI = process.env.REACT_APP_WEBSOCKET_URI;
  var self = _this;
  var wSocket;
  var messageClient;
  var clientMessageQueue = [];
  var taskReducer = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(task) {
      var data, client, action, payload;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            data = task.data, client = task.client;
            ...
            _context.t0 = action;
            _context.next = _context.t0 === 'UPDATE_LINK_DATA' ? 6 : _context.t0 === 'GENERATE_SUMMARY' ? 8 : _context.t0 === 'GENERATE_SUMMARY_FROM_QUERY' ? 10 : _context.t0 === 'CHECK_FOR_NEW_RECORDS_BEGIN' ? 12 : _context.t0 === 'CHECK_APPLIED' ? 14 : _context.t0 === 'CHECK_OLDEST_24' ? 16 : 18;
            break;
          case 6:
    ...
    return function taskReducer(_x) {
      return _ref.apply(this, arguments);
    };
  }();
  var processQueue = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var task, client, dispatchMsg;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            task = clientMessageQueue.shift();
            client = task.client;
            dispatchMsg = JSON.stringify({
  ...
  var initWebWorker = /*#__PURE__*/function () {
    ...
    return function () {
      if (event.origin === websocketURI) {
        ...
        if (receiver === 'webworker') {
          console.log('Service worker received websocket message: ', {
            message: message
          });
          ...
          var newRecordsChecked = ['NO_NEW_RECORDS', 'FETCH_NEW_RECORDS_SUCCESS'];
          ...
          var applicationsChecked = ['CHECK_APPLIED_COMPLETE', 'CHECK_APPLIED_INCOMPLETE'];
        ...
        console.log('Service worker received postMessage: ', {
          data: _data,
          client: client
        });
        if (_data.action === 'SERVICE_WORKER_REGISTERED') {
          sendWS(JSON.stringify({
  ...
  var reconnectWS = /*#__PURE__*/function () {
    ...
    return function reconnectWS() {
      return _ref4.apply(this, arguments);
    };
  }();
  var sendWS = /*#__PURE__*/function () {
    ...
    return function sendWS(_x2) {
      return _ref6.apply(this, arguments);
    };
  }();
  var sendPostMessage = function sendPostMessage(payload) {
    try {
